              ...
              <Card className="p-6 bg-background/50 backdrop-blur">
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-4 gap-4">
                    ...
                    <div className={`space-y-2 ${workflow === 'animated' ? 'opacity-50 pointer-events-none' : ''}`}>
                      <Label htmlFor="loraScale" className="text-sm font-medium block">Character Reference Strength</Label>
                      <Select value={loraScale} onValueChange={setLoraScale} disabled={workflow === 'animated'}>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <Input 
                        ...
                        className="hidden" 
                        disabled={isUploading || isProcessing || workflow === 'animated'} 
                      />
                      <div className="relative">
