          ...
          <Auth
            ...
            appearance={{
              ...
              className: {
                ...
                divider: "!bg-white/20",
                message: "!text-white",
                input: "w-full !bg-transparent !border !border-white/20 !text-white !rounded-md !px-2 !py-1.5 focus:!border-primary hover:!border-primary/80 transition-colors !min-w-full",
              },
            }}
            view="sign_in"
            providers={[]}
