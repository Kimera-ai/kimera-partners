            ...
            <TooltipTrigger asChild>
              {!imagePreview ? (
                <div 
                  ...
                  className={`h-8 w-8 rounded-md flex items-center justify-center ${workflow === 'no-reference' ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer bg-gradient-to-r from-purple-500 to-pink-500 hover:opacity-90'} transition-colors`}
                >
