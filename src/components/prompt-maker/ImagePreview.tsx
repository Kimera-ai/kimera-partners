...
export const ImagePreview = ({
  ...
  return (
    <button 
      type="button" 
      className={`h-12 w-12 rounded-md bg-white/5 backdrop-blur border border-white/10 p-1 hover:bg-white/10 group relative ${disabled ? 'opacity-50 cursor-not-allowed' : ''}`} 
      onClick={onRemove} 
