    ...
    <div className="mb-8 space-y-6">
      <div className="relative w-full max-w-2xl mx-auto">
        ...
        <Input
          ...
          className="pl-12 h-12 w-full bg-white/[0.03] border-white/10 text-white placeholder:text-gray-400 focus:border-primary/50 focus:ring-primary/20 transition-all rounded-lg"
        />
      </div>
